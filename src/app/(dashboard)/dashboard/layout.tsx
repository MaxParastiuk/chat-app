...
const Layout = async ({ children }: layoutProps) => {
  ...
  return (
    <div className="w-full flex h-screen first-line:">
      ...
      <div className="hiddne md:flex h-full w-full max-w-xs grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6">
        ...
        <nav className="flex flex-1 flex-col">
          <ul role="list" className="flex flex-1 flex-col gap-y-7">
            ...
            <li className="-mx-6 mt-auto flex  items-center">
              <div className="flex flex-1 items-center gap-x-4 px-4 py-4 text-sm font-semibold leading-6 text-gray-900">
